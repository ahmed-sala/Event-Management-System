...
public class EditUsersForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EditUsersForm
     */
    CustomerDB customer = new CustomerDB();

    public EditUsersForm() throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Age", "Phone", "Email", "Password", "Role"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AdminDB edit = new AdminDB();
        edit.editUsers(jTable1);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(EditUsersForm.class.getName()).log(Level.SEVERE, null, ex);
                } catch (SQLException ex) {
                    Logger.getLogger(EditUsersForm.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
