...
public class ProjectManagerForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ProjectManagerForm
     */
    ProjectManagerDB pm = new ProjectManagerDB();

    public ProjectManagerForm() throws ClassNotFoundException, SQLException {
        initComponents();
        pm.fillStudentJTable(jTable1);
    ...
    private void initComponents() {
        ...
        jButton4.setText("Contact Customer");
        ...
        jButton5.setText("Send Request to Service Provder");
        ...
        jButton6.setText("Send Request to Customer");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(17, 17, 17)
                .addComponent(jLabel_Username, javax.swing.GroupLayout.DEFAULT_SIZE, 314, Short.MAX_VALUE)
                .addGap(367, 367, 367)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            PMContactsC pmcc = new PMContactsC();
            pmcc.setVisible(true);
            pmcc.pack();
            pmcc.setLocationRelativeTo(null);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            pm.ProjectManagerToServiceProvider(jTable1);
        } catch (SQLException ex) {
            Logger.getLogger(ProjectManagerForm.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ProjectManagerForm.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            pm.ProjectManagerToCustomer(jTable1);
        } catch (SQLException ex) {
            Logger.getLogger(ProjectManagerForm.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ProjectManagerForm.class.getName()).log(Level.SEVERE, null, ex);
